...
public class AppointmentController {
    ...
    public ApiResponse<Map<String, Object>> createAppointment(
        ...
        Map<String, Object> result = appointmentService.createAppointmentWithPayment(request, gateway, httpRequest);
    ...
    ApiResponse<AppointmentResponse> deleteAppointment(@PathVariable Long appointmentId) {
        ...
        return ApiResponse.<AppointmentResponse>builder().build();
    }
    ...
    ApiResponse<List<AppointmentResponse>> getAllAppointmentByDate(
